  ...
  return (
    <div className="animate-slide-up space-y-8 p-4 relative min-h-screen pb-24">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 border-b border-white/5 pb-6">
        <div>
          <h1 className="font-outfit text-4xl font-black tracking-tight uppercase text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="flex justify-between items-center">
            <h2 className="font-outfit text-xl font-bold uppercase tracking-wider text-white">
          ...
          {loading ? (
            ...
            <Card className="text-center py-16 border-dashed border-white/10 flex flex-col items-center justify-center">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="flex justify-between items-center">
            <h2 className="font-outfit text-xl font-bold uppercase tracking-wider text-white flex items-center gap-2">
