  ...
  return (
    <div className="animate-slide-up space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-white/5 pb-6">
        <div>
          <h1 className="font-outfit text-4xl font-black tracking-tight uppercase">Client <span className="text-secondary">Archive</span></h1>
        ...
        <div className="flex gap-3 w-full md:w-auto">
          <div className="relative flex-1 md:w-64">
            ...
            <input 
              ...
              className="w-full bg-background border border-border/60 hover:border-border rounded-xl pl-10 pr-4 py-3 font-mono text-[9px] uppercase tracking-widest focus:border-secondary outline-none transition-all"
            />
          </div>
          <Link 
