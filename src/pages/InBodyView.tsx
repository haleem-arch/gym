                    ...
                    >
                      <div className="p-5 bg-black/20 space-y-6">
                        ...
                        <div>
                          ...
                          <div className="bg-gray-800/30 p-4 rounded-2xl border border-gray-700/50 relative">
                            ...
                            <div className="flex justify-between mb-4">
                              <div className="text-center">
                                ...
                                <p className="text-xs text-gray-500">{prev && calculateDelta(seg.laLean, prevSeg.laLean)}</p>
                              </div>
                              <div className="text-center">
                                <p className="text-[10px] text-gray-500 mb-1">Right Arm</p>
                                <p className="text-sm font-bold text-white">{seg.raLean || 0}kg</p>
                                <p className="text-xs text-gray-500">{prev && calculateDelta(seg.raLean, prevSeg.raLean)}</p>
                              </div>
                            </div>
                            
                            <div className="flex justify-center mb-4">
                              <div className="text-center bg-gray-800/50 px-6 py-3 rounded-xl border border-gray-700">
                                <p className="text-[10px] text-gray-500 mb-1">Trunk</p>
                                <p className="text-base font-bold text-white">{seg.trunkLean || 0}kg</p>
                            ...
                            <div className="flex justify-between">
                              <div className="text-center">
                                ...
                                <p className="text-xs text-gray-500">{prev && calculateDelta(seg.llLean, prevSeg.llLean)}</p>
                              </div>
                              <div className="text-center">
                                <p className="text-[10px] text-gray-500 mb-1">Right Leg</p>
                                <p className="text-sm font-bold text-white">{seg.rlLean || 0}kg</p>
                                <p className="text-xs text-gray-500">{prev && calculateDelta(seg.rlLean, prevSeg.rlLean)}</p>
                              </div>
                            </div>
                          </div>
                        </div>
