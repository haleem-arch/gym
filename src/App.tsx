...
function App() {
  ...
  return (
    <Router>
      <div className="flex flex-col h-[100dvh] bg-background text-gray-100 font-sans w-full max-w-[430px] mx-auto relative overflow-hidden shadow-2xl border-x border-gray-800">
