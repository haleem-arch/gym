...
export default async function handler(req: any, res: any) {
  ...
  // Only authenticate JWT token if action is not 'whatsapp-incoming' or 'retry-whatsapp'
  if (action !== 'whatsapp-incoming' && action !== 'retry-whatsapp') {
